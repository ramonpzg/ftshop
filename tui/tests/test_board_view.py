...
stable cell widths, White at the bottom unless flipped."""
...
def test_reference_position_renders_exactly_like_the_spec():
...
def test_every_line_fits_the_fixed_width():
    ...
    for line in board_lines(board_grid(fen)):
        assert len(line) <= BOARD_WIDTH

...
@app.cell
def _(compute_reward, game_records, json, mo):
...
def _(CAPS, httpx, json, mo, os):
    ...
    return llm_chat, parse_move_reply
...
@app.cell
def _(CAPS, game_records, json, llm_chat, mo):
    real_world_maps = []
    if CAPS["openai_key"]:
...
@app.cell
def _(PROMPT_TEMPLATE, all_rows, json, mo, os):
...
@app.cell
def _(all_rows, json, mo, parse_move_reply):
...
@app.cell
def _(CAPS, httpx, img_captions, mo, os):
    import time
    ...
    _out4
    return fal_run, img_url


@app.cell
def _(CAPS, img_captions, img_url, json, llm_chat, mo):
...
def _(mo):
    ...
    return aud_click_wav, aud_rate, np
...
def _(CAPS, mo):
    ...
    _out6
    return (aud_generated,)


@app.cell
def _(aud_click_wav, aud_generated, aud_rate, mo, np):
